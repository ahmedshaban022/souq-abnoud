...
const Header = () => {
  ...
  <div className="container">
    ...
    <button className='btn text-white fw-bold' style={{border:"none"}} onClick={handleChangeTheam}>{theam ==="light"?<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-stars-fill" viewBox="0 0 16 16">
